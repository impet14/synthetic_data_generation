function [ traj_opt ] = random_traj( traj_dir , K,dis_threshold)%num_traj)
...
save('original.mat','traj'); %m added for saving original traj
A = eye(N);
x = eye(N-1)*-2;
...
save('random_traj.mat','traj_opt') %m added for save randome trajectories
